...
We can also look at the standart errors and p-values and conclude that some of those variable estimates may be equal to 0. However setting them to 0 would not change much in terms of fitting the data or change the interpretation of the model.
#vérifie si je bullshit pas la.
````{r model diagnostic}
...
The final problem is that our model don't gives us much insight on the fungal expension. Our model try to predict the rate of fungal expension for a given race without taking care of the temperature or maturity of the apple. But it doesn't tell us how this rate changes depending on the temperature.
